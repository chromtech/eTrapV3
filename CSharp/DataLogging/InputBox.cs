...
namespace MsgBox
{
    public static class InputBox
    {
        ...
        private static PictureBox Picture(Icon icon)
        {
            ...
            {
                case Icon.Error:
                    myicon = SystemIcons.Warning.ToBitmap();
                    break;
                case Icon.Exclamation:
                    myicon = SystemIcons.Exclamation.ToBitmap();
                    break;
                case Icon.Information:
                    myicon = SystemIcons.Information.ToBitmap();
                    break;
                case Icon.Question:
                    myicon = SystemIcons.Question.ToBitmap();
                    break;
                case Icon.Nothing:
                    myicon = SystemIcons.Hand.ToBitmap();
                    break;
            }
            picture.Image = myicon;
