...
namespace SendAndReceive
{
    ...
    public class SendAndReceive
    {
        ...
        // Setup function   NOT CALLED BY ANYONE !!!
        public void Setup()
        {
            ...
            _serialTransport = new SerialTransport(0, "COM30")
            {
                CurrentSerialSettings = { PortName = "COM1", BaudRate = 115200, DtrEnable = false } // object initializer
            };
